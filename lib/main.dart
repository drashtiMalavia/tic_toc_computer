...
import 'dart:math';
void main() {
  runApp(MaterialApp(home: tictocRan(),debugShowCheckedModeBanner: false,));
}
class tictocRan extends StatefulWidget {
  const tictocRan({super.key});

  @override
  State<tictocRan> createState() => _tictocState();
}

class _tictocState extends State<tictocRan> {
  List li=[],li2=[],li3=[],li4=[];
  Random random=new Random();
  String ans = "", ans1 = "",ans2 = "", ans3 = "", ans4 = "", ans5 = "", ans6 = "", ans7 = "", ans8 = "", ans9 = "", btn = "",win="";
  int i = 1, cnt = 0,j=0,r=0;
  int fnd = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Tic-Toc Game with computer"),
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          style: ButtonStyle(backgroundColor: WidgetStatePropertyAll(Colors.pink.shade100)),
                            onPressed: () {
                          logic("1");
                    ...
                    Expanded(
                      child: Container(
                        width: 100,
                        height: 100,
                        child: ElevatedButton(style: ButtonStyle(backgroundColor: WidgetStatePropertyAll(Colors.pink.shade100)),onPressed: () {
                          logic("2");
